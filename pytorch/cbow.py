...
odel_cbow, epomch_losses=train_model(model_cbow, dataloader_cbow, criterion, optimizer, num_epochs=400)
#checking wheteher similiar words are grouped together
